                ...
                >
                    ...
                    >
                        ...
                        <div style={s.btnContainer}>
                            <RaisedButton label='确认注册' style={s.submitBtn} secondary={true} onClick={this._signUpSubmitAction}></RaisedButton>
                        </div>
                    </Tab>
                    <Tab
                        label='登录'
                    ...
                    >
                        ...
                        <TextField
                            ...
                            /><br />
                            <div style={s.btnContainer}>
                                <RaisedButton label='登录' style={s.submitBtn} secondary={true}></RaisedButton>
                            </div>
                    </Tab>
                </Tabs>
